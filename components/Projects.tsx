...
const projects = [
  {
    ...
    description: "A production-grade architecture designed for deploying Large Language Models at scale while maintaining rigorous latency standards. The pipeline orchestrates model routing, intelligent caching, and comprehensive cost-optimization strategies across distributed GPU environments. We emphasize observability through deep integration with Langfuse and LangChain for real-time monitoring.",
    bullets: [
  ...
  },
  {
    ...
    description: "A production-ready fraud detection framework leveraging advanced machine learning techniques to monitor transaction streams in real-time. Behavioral modeling and anomaly detection identify suspicious patterns before they escalate.",
    bullets: [
  ...
  {
    title: "RNNs to Transformers: A Technical Survey",
    description: "A foundational-to-advanced technical survey bridging classic sequence models to modern Transformer-based LLMs. Clear PyTorch implementations demystify the mathematics behind RNNs, LSTMs, GRUs, and why Transformers dominate.",
    bullets: [
      "Mathematics of RNNs, LSTMs & GRUs",
      "Transformer architecture deep-dive",
      "Used by 3 educational platforms"
    ],
    tech: ["PYTORCH", "TYPESCRIPT", "MARKDOWN", "TAILWIND", "SANITY"],
...
export default function Projects() {
  return (
    <section className="relative py-32 px-6 md:px-12 bg-[#050505] overflow-hidden">
      {/* Enhanced background with purple + green neon aesthetic */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative rounded-3xl overflow-hidden border border-gray-800/60 hover:border-[#00FF41]/40 transition-all duration-400 bg-black/40 backdrop-blur-sm"
            >
              ...
              <div className="p-8 relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="text-xs px-3 py-1 bg-gray-900/80 rounded-full text-gray-300 border border-gray-700 font-mono uppercase tracking-wider"
                    >
                      {tech}
                    </span>
                  ))}
